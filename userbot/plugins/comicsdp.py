...
@borg.on(admin_cmd(pattern="comicsdp ?(.*)"))
...
CMD_HELP.update(
  {
    "Anime DP": "`.comicsdp`"
    "\nUsage - Auto-changing dp of Comics Every 5 Mins(Default). \n\n"
    "`.comicsdp` <delay> <s or S for seconds, m or M for minute(s) Delay, h or H for hour(s) Delay and d or D for Day(s) Delay>"
    "\nUsage - Auto-changing dp of Comics with custom Delay. \n\n"
  }
)
