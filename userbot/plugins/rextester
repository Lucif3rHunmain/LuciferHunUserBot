...
CMD_HELP.update(
    {
        ...
        \nUsage - Run codes of any language inside telegram. Available languages can be found [here](https://github.com/nitanmarcel/rextester_py#languages)."
    }
)
